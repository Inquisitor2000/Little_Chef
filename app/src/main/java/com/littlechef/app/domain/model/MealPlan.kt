...
enum class MealType(val displayName: String, val emoji: String) {
    ...
    fun getLocalizedName(context: android.content.Context): String {
        return when (this) {
            BREAKFAST -> context.getString(com.littlechef.app.R.string.meal_type_breakfast)
            LUNCH -> context.getString(com.littlechef.app.R.string.meal_type_lunch)
            DINNER -> context.getString(com.littlechef.app.R.string.meal_type_dinner)
            SNACK -> context.getString(com.littlechef.app.R.string.meal_type_snack)
            DESSERT -> context.getString(com.littlechef.app.R.string.meal_type_dessert)
        }
    }
}

    ...
    suspend operator fun invoke(
        ...
        if (ingredient == null) {
            ...
            val storageUnit = if (catalogIngredient != null) {
                ...
                android.util.Log.d("AddGroceryItemToPantry", "isVolumeUnit: ${com.littlechef.app.domain.model.UnitConversion.isVolumeUnit(catalogIngredient.defaultUnit)}")
                android.util.Log.d("AddGroceryItemToPantry", "isWeightUnit: ${com.littlechef.app.domain.model.UnitConversion.isWeightUnit(catalogIngredient.defaultUnit)}")
                
                // For countable items (pcs, etc.), use the catalog's default unit directly
                if (!com.littlechef.app.domain.model.UnitConversion.isVolumeUnit(catalogIngredient.defaultUnit) &&
                    !com.littlechef.app.domain.model.UnitConversion.isWeightUnit(catalogIngredient.defaultUnit)) {
                ...
                if (!com.littlechef.app.domain.model.UnitConversion.isVolumeUnit(groceryItem.unit) &&
                    !com.littlechef.app.domain.model.UnitConversion.isWeightUnit(groceryItem.unit)) {
                    groceryItem.unit
                } else {
                    if (com.littlechef.app.domain.model.UnitConversion.isVolumeUnit(groceryItem.unit)) {
                        "ml"
        ...
        val quantityInIngredientUnit = if (groceryItem.unit != ingredient.unit) {
            ...
            if (!com.littlechef.app.domain.model.UnitConversion.isVolumeUnit(groceryItem.unit) &&
                !com.littlechef.app.domain.model.UnitConversion.isWeightUnit(groceryItem.unit) &&
                !com.littlechef.app.domain.model.UnitConversion.isVolumeUnit(ingredient.unit) &&
                !com.littlechef.app.domain.model.UnitConversion.isWeightUnit(ingredient.unit)) {
                ...
                val storageResult = com.littlechef.app.domain.model.UnitConversion.toStorageUnit(
                    groceryItem.quantity,
                    groceryItem.unit
                )

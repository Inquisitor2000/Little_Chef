...
class CreateScrapedMealUseCase @Inject constructor(
    ...
    suspend operator fun invoke(
        ...
        finalName: String,
        mealType: com.littlechef.app.domain.model.MealType? = null,
        dishCategory: com.littlechef.app.domain.model.DishCategory? = null,
        ...
        val ingredientInputs = mutableListOf<com.littlechef.app.domain.repository.MealIngredientInput>()

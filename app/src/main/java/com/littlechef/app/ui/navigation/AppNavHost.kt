...
import com.littlechef.app.ui.screens.CuisineMealsScreen
import com.littlechef.app.ui.screens.GroceriesScreen
import com.littlechef.app.ui.screens.ManualRecipeScreen
import com.littlechef.app.ui.screens.MealPlanDetailScreen
import com.littlechef.app.ui.screens.MealsScreen
import com.littlechef.app.ui.screens.PantryScreen
import com.littlechef.app.ui.screens.PlanScreen
import com.littlechef.app.ui.screens.RecipeDetailScreen
import com.littlechef.app.ui.screens.ScrapeRecipeScreen
import com.littlechef.app.ui.screens.SettingsScreen
import com.littlechef.app.ui.screens.SuggestionScreen
...
fun AppNavHost(
    ...
    NavHost(
        ...
        composable(NavDestination.ManualRecipe.route) { backStackEntry ->
            val viewModel: com.littlechef.app.ui.screens.ManualRecipeViewModel = hiltViewModel()
            ...
            LaunchedEffect(customIngredientName, customIngredientQuantity, customIngredientUnit) {
                if (customIngredientName != null && customIngredientQuantity != null && customIngredientUnit != null) {
                    ...
                    viewModel.updateIngredient(
                        ...
                        com.littlechef.app.ui.screens.ManualRecipeIngredient(
        ...
        composable(
            ...
            val mealId = backStackEntry.arguments?.getString("mealId") ?: return@composable
            com.littlechef.app.ui.screens.EditRecipeScreen(
                mealId = mealId,
                onNavigateBack = { navController.popBackStack() }
            )
        }
        ...
        composable(
            ...
            val pantryViewModel: com.littlechef.app.ui.screens.PantryViewModel = hiltViewModel()
            val coroutineScope = androidx.compose.runtime.rememberCoroutineScope()
            
            com.littlechef.app.ui.screens.AddCustomIngredientScreen(
        ...
        composable(
            ...
            val initialName = backStackEntry.arguments?.getString("initialName") ?: ""
            val groceriesViewModel: com.littlechef.app.ui.screens.GroceriesViewModel = hiltViewModel()

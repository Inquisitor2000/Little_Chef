...
class MealPlannerApp : Application(), ImageLoaderFactory {
    ...
    @Inject
    lateinit var imagePreloader: com.familymealplanner.data.local.ImagePreloader
    
    @Inject
    lateinit var substituteInitializer: com.familymealplanner.data.local.SubstituteInitializer

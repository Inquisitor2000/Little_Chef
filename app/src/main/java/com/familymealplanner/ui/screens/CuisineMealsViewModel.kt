...
object CatalogLookupCache {
    val map: Map<String, CatalogIngredient> by lazy {
        ...
        com.familymealplanner.domain.model.IngredientCatalog.allIngredients.forEach { ingredient ->
...
class CuisineMealsViewModel @Inject constructor(
    ...
    private val onboardingPreferences: com.familymealplanner.data.preferences.OnboardingPreferences,
    private val ingredientMatcher: IngredientMatcher,
    private val preloadCuisineAllergensUseCase: PreloadCuisineAllergensUseCase,
    private val favoriteRecipesPreferences: com.familymealplanner.data.preferences.FavoriteRecipesPreferences
) : ViewModel() {
    ...
    private fun findAllergensFromCatalog(ingredientName: String): List<Allergen> {
        ...
        return if (catalogIngredient != null && catalogIngredient.allergens.isNotEmpty()) {
            catalogIngredient.allergens.map { commonAllergen: com.familymealplanner.domain.model.CommonAllergen ->
                Allergen(

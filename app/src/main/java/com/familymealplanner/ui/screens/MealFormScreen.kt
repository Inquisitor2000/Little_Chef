...
fun MealFormScreen(
    ...
    var selectedMealType by remember { mutableStateOf<com.familymealplanner.domain.model.MealType?>(null) }
    var selectedDishCategory by remember { mutableStateOf<com.familymealplanner.domain.model.DishCategory?>(null) }
            ...
            Row(
                ...
                ExposedDropdownMenuBox(
                    ...
                    ExposedDropdownMenu(
                        ...
                        com.familymealplanner.domain.model.MealType.entries.forEach { type ->
                            DropdownMenuItem(
                ...
                ExposedDropdownMenuBox(
                    ...
                    ExposedDropdownMenu(
                        ...
                        com.familymealplanner.domain.model.DishCategory.entries.forEach { category ->
                            DropdownMenuItem(

...
import com.familymealplanner.domain.model.MealIngredient
...
class MealRepositoryImpl @Inject constructor(
    ...
    private val ingredientAllergenDao: com.familymealplanner.data.local.dao.IngredientAllergenDao,
    private val allergenDao: com.familymealplanner.data.local.dao.AllergenDao,
    private val ingredientSubstituteDao: com.familymealplanner.data.local.dao.IngredientSubstituteDao,
    ...
    private val ingredientMatcher: com.familymealplanner.domain.util.IngredientMatcher
) : MealRepository {
    ...
    private suspend fun MealEntity.toDomainWithIngredients(): Meal {
        ...
        return Meal(
            ...
            isBundled = isBundled,
            imagePath = imagePath,
            mealType = mealType?.let { com.familymealplanner.domain.model.MealType.valueOf(it) },
            dishCategory = dishCategory?.let { com.familymealplanner.domain.model.DishCategory.valueOf(it) },
    ...
    private suspend fun IngredientEntity.toDomain(): Ingredient {
        ...
        val catalogAllergens = mutableListOf<com.familymealplanner.domain.model.Allergen>()
        ...
        val substitutes = substituteEntities.mapNotNull { substituteEntity ->
            ingredientDao.getById(substituteEntity.substituteId)?.let { subIngredientEntity ->
                com.familymealplanner.domain.model.IngredientSubstitute(

...
public final class CheckRecipeIngredientsUseCase_Factory implements Factory<CheckRecipeIngredientsUseCase> {
  private final Provider<InventoryRepository> inventoryRepositoryProvider;

  private final Provider<IngredientRepository> ingredientRepositoryProvider;

  public CheckRecipeIngredientsUseCase_Factory(
  ...
  @Override
  public CheckRecipeIngredientsUseCase get() {
    return newInstance(inventoryRepositoryProvider.get(), ingredientRepositoryProvider.get());
  }

  public static CheckRecipeIngredientsUseCase_Factory create(
      Provider<InventoryRepository> inventoryRepositoryProvider,
      Provider<IngredientRepository> ingredientRepositoryProvider) {
    return new CheckRecipeIngredientsUseCase_Factory(inventoryRepositoryProvider, ingredientRepositoryProvider);
  }

  public static CheckRecipeIngredientsUseCase newInstance(InventoryRepository inventoryRepository,
      IngredientRepository ingredientRepository) {
    return new CheckRecipeIngredientsUseCase(inventoryRepository, ingredientRepository);
  }
}

...
public final class RestockIngredientUseCase_Factory implements Factory<RestockIngredientUseCase> {
  private final Provider<InventoryRepository> inventoryRepositoryProvider;

  private final Provider<IngredientRepository> ingredientRepositoryProvider;

  public RestockIngredientUseCase_Factory(Provider<InventoryRepository> inventoryRepositoryProvider,
  ...
  @Override
  public RestockIngredientUseCase get() {
    return newInstance(inventoryRepositoryProvider.get(), ingredientRepositoryProvider.get());
  }

  public static RestockIngredientUseCase_Factory create(
      Provider<InventoryRepository> inventoryRepositoryProvider,
      Provider<IngredientRepository> ingredientRepositoryProvider) {
    return new RestockIngredientUseCase_Factory(inventoryRepositoryProvider, ingredientRepositoryProvider);
  }

  public static RestockIngredientUseCase newInstance(InventoryRepository inventoryRepository,
      IngredientRepository ingredientRepository) {
    return new RestockIngredientUseCase(inventoryRepository, ingredientRepository);
  }
}
